...
def pretrainSimCLR(path_to_chex):
    ...
    for i in os.listdir(path_to_chex):
        ...
        for j in os.listdir(path_to_chex + i):
            for k in os.listdir(path_to_chex + i + '/' + j):
                ...
                io.imsave("Project directory/Chexpert_simclr/" + i + '_' + str(c) + '.png', img)
    ...
    path_to_data = 'Project directory/Chexpert_simclr'
    ...
    len(os.listdir("Project Directory/Chexpert_simclr"))
